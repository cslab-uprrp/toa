...
function dspData(request_type)
{
    ...
    setInterval(updateParticles,parseInt(1000*3)) ;// We add(and remove) cube from the point each 5 seconds.
}
...
/*document.getElementById('opt').onchange= function(){
	if (this.value == 'packets') document.getElementById('unit').style.display='none';
	else document.getElementById('unit').style.display='inline';
};*/
