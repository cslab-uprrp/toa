...
if UserModel.connect() and SessionModel.connect() and NetworkModel.connect():
    ...
    print """<center><ul><li><a href=".cgi?uid=%s&sid=%s&remote=%s"><div id="mMyAcc"><p>My Account</p></div></a></li><li><a href="ManageNet2Net.cgi?uid=%s&sid=%s&remote=%s"><div id="mAcc"><p>Manage Accounts</p></div></a></li><li><a href="../../Controllers/Logout.cgi?uid=%s&sid=%s&remote=%s"><div id="mLog"><p>Logout</p></div></a></li></ul></center>"""%(uid, sid, remote, uid, sid, remote, uid, sid, remote)
